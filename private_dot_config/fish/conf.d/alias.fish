...
# function maj --description "Update the system and home-manager’s configuration without upgrading the system"
...
# function maj_upgrade --description "Upgrades the flakes versions then updates the system and home-manager"
#     while ! ping -c1 www.google.fr >/dev/null 2>&1
#         sleep 1
#     end
#     set PWD2 (pwd)
...
#     set HM $status
#     cd $PWD2
#     echo "Home-Manager update: $HM ; System update: $GLOBAL"
#     if test $GLOBAL -eq 0 -a $HM -eq 0
