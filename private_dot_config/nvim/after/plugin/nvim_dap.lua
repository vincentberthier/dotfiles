...
if not status then
	print("Couldn’t load nvim-dap: no debugging available.")
	return
end

local status_ui, dapui = pcall(require, "dapui")
if not status_ui then
	print("Couldn’t load nvim-dap-ui: no debugging available")
	return
end

local status_proj, dap_projects = pcall(require, "nvim-dap-projects")
if not status_proj then
	print("Couldn’t load nvim-dap-projects: no debugging available")
	return
end
