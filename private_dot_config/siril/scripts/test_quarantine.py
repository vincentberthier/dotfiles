import sys, math
sys.path.insert(0, "/home/vincent/.config/siril/scripts")
import astro_hibou_core as C
from pathlib import Path

TMP = Path("/tmp/claude-1000/-run-media-vincent-Corrbolg-Astro/e68f4da0-cc95-47c3-9024-18ee6086565a/scratchpad")
